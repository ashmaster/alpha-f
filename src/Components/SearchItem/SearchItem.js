                ...
                <div className="item">
                    ...
                    <div className="details">
                        ...
                        <div className="subtitle">
                            <p>{!(itemType(item) === "CHANNEL") ? (itemType(item) === "PLAYLISTITEM") ? channelTitle(item.snippet.videoOwnerChannelTitle) + ", " : item.snippet.channelTitle + ", " : ""} {itemType(item) === "VIDEO" || itemType(item) === "PLAYLISTITEM" ? "MUSIC" : itemType(item) === "CHANNEL" ? "ARTIST" : itemType(item)}</p>
                        </div>
                    </div>
                </div>
